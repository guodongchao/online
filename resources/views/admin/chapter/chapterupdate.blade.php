...
<div id="pageAll">
    ...
    <div class="page ">
        ...
        <div class="banneradd bor">
            ...
            <div class="baBody">
                <input type="hidden" id="qweqf" value="{{$chapterdata->chapter_id}}">
                <input type="hidden" id="dasgva" value="{{$culum_id}}">
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;章节名称：<input type="text" name="chapter_name" value="{{$chapterdata->chapter_name}}" class="input3" />
                </div>
                <br>
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;章节简介：
                    <div class="row cl">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block"style="width: 73%;margin-left: 8%">
                                <textarea id="LAY_demo1" style="display: none;" name="file">{{$chapterdata->chapter_desc}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    layui.use(['layer','form','layedit'], function() {
        ...
        $('#btn').click(function(){
            ...
            var culum_id = $('#dasgva').val();

            $.post(
                'chapterUpdateDo',
                {chapter_name:chapter_name,chapter_desc:chapter_desc,chapter_id:chapter_id,culum_id:culum_id},
                function(res){
                    if(res.code==0) {
                        layer.open({
                            type:0,
