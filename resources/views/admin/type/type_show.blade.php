        ...
        <div class="connoisseur">
            ...
            <div class="conShow">
                <table border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="66px" class="tdColor tdC">商品类型id</td>
                        <td width="355px" class="tdColor">商品类型名称</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href=""><input type="button" value="属性管理"></a>
                            <a href="type_update"><img class="operation" src="img/update.png"></a>
                            <img class="operation delban" src="img/delete.png" onclick="type_del()">
                        </td>
                    </tr>
                </table>
            </div>
